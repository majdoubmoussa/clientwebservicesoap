 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://wservice/", wsdlLocation = "http://localhost:8787/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://wservice/", "BanqueWS");
     ...
     *     returns BanqueW
     */
    @WebEndpoint(name = "BanqueWPort")
    public BanqueW getBanqueWPort() {
        return super.getPort(new QName("http://wservice/", "BanqueWPort"), BanqueW.class);
    }
     ...
     */
    @WebEndpoint(name = "BanqueWPort")
    public BanqueW getBanqueWPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wservice/", "BanqueWPort"), BanqueW.class, features);
    }
