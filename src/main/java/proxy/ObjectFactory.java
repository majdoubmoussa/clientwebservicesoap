...
public class ObjectFactory {
    ...
    private static final QName _ConversionEuroToDH_QNAME = new QName("http://wservice/", "ConversionEuroToDH");
    private static final QName _ConversionEuroToDHResponse_QNAME = new QName("http://wservice/", "ConversionEuroToDHResponse");
    private static final QName _GetCompte_QNAME = new QName("http://wservice/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://wservice/", "getCompteResponse");
    private static final QName _GetComptes_QNAME = new QName("http://wservice/", "getComptes");
    private static final QName _GetComptesResponse_QNAME = new QName("http://wservice/", "getComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://wservice/", name = "ConversionEuroToDH")
     ...
     */
    @XmlElementDecl(namespace = "http://wservice/", name = "ConversionEuroToDHResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://wservice/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://wservice/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://wservice/", name = "getComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://wservice/", name = "getComptesResponse")
